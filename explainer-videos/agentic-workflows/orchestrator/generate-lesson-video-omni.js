...
const MOTION = {
  ...
  '10': 'a lead robot with an amber scarf hands three work parcels to three worker robots lined up at a shop counter, coordinated handing motion, gentle ambient',
  '11': 'three worker robots work in parallel, one arranges sweets, one packs a gift box, one writes a note, lively busy flat 2D animation',
  '13': 'a gentle ambient motion, soft light',
  '14': 'a gentle ambient motion, soft light',
  '15': 'a lead robot holds up a short stack of boxes beside a tall stack of sweets, notices the shortfall and hands the boxes back, small concerned motion',
