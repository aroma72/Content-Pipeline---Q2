...
const MOTION = {
  '02': 'the young man stands at his fruit stall looking a little worried, glancing down at a small basket of mangoes on the counter, he blinks and shifts his weight, soft ambient market motion',
  '03': 'the young man tastes a small slice of mango thoughtfully, a quiet reflective nod, gentle motion',
  '04': 'the young man gives a small uncertain shrug with open hands while looking down at the basket, gentle thinking motion, subtle head tilt',
  '05': 'the young man frowns slightly and gestures toward a delivery van behind him as a crate is dropped off, deciding firmly, gentle motion',
  '08': 'the older grey-haired shopkeeper leans over kindly and speaks, gesturing toward the basket of mangoes, the young man listens and gives a small nod, gentle empathetic motion, no big movement',
  '09': 'the young man tips a woven basket and a spill of mangoes tumbles out across the wooden counter, a gentle pouring motion, calm',
  '10': 'the young man holds up a single small green mango close to his face and inspects it, a slight turn of the wrist, focused',
  '11': 'the young man examines the small green mango and sets it down to begin a first little group on the counter, calm hand motion',
  '12': 'the young man turns a bruised mango to look at the dark patch, a small frown of recognition, gentle motion',
  '13': 'the young man works steadily through a wide spread of mangoes, picking each one up in turn and setting it down, patient repeating motion',
  '14': 'the young man uses both hands to push mangoes into four tidy separate piles, sorting them, a calm sweeping motion',
  '16': 'the young man stands back and looks over four piles of mangoes, his gaze settling on the tallest pile, a small realisation, gentle motion',
  '18': 'the young man looks down thoughtfully between a tall pile of mangoes and a tiny pile of two, a slow understanding nod, gentle motion',
  '19': 'the young man lifts a heavy sack of onions off a wooden crate at the back of a van and discovers the mangoes underneath, an effortful then surprised motion, gentle',
  '21': 'the young man carefully lines the wooden crate with sheets of plain paper as padding, a careful tucking motion, calm and satisfied',
  '23': 'the young man stands confidently beside a neat crate of mangoes, a slow satisfied breath and a small smile, gentle motion',
  '24': 'the young man faces forward with a warm smile and an open, inviting hand gesture, encouraging, natural motion',
  '25': 'the young man gestures as if laying several cards in a row in front of him, friendly and clear, gentle motion',
  '26': 'the young man makes a two-handed gathering gesture as if pushing things together into one group, cheerful and clear, gentle motion',
  '28': 'the young man gives a confident warm smile and a small thumbs up, a reassuring nod',
};
