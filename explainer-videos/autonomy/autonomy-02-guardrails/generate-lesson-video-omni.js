...
const MOTION = {
  ...
  '08': 'a small delivery van smoothly approaches and begins to round a mountain bend past a sturdy roadside barrier, gentle forward motion, clouds and roadside grass drift softly',
  '09': 'a soft shimmer of light, a very gentle settling camera, calm ambient motion',
  '10': 'a gentle ambient motion, soft light',
  '11': 'a gentle ambient motion, soft light',
  '13': 'the small robot assistant slides a refund across the counter to the woman customer and logs it while the shopkeeper restocks a shelf behind without looking up, calm parallel motion, gentle ambient',
  '14': 'the male customer gestures for a large refund, the small robot assistant politely raises a hand to pause and turns to ask the shopkeeper, subtle empathetic motion, no big movement',
