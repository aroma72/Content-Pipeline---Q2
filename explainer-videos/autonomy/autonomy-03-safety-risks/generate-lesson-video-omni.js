...
const MOTION = {
  ...
  '07': 'a sly stranger hunches over a phone typing a deceptive message with a scheming grin, subtle sneaky motion, dim moody light',
  '08': 'the small robot assistant at the counter reads a message and processes a large refund, banknotes slide out of the open till, no shopkeeper present, uneasy calm motion',
  '09': 'a hand reaches toward the open till as banknotes leave it and stops short, unable to pull it back, a still heavy moment, minimal motion',
