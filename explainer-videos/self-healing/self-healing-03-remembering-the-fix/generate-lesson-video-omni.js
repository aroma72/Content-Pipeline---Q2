...
// Tuned for VIDEO 03 (self-improving: where the learning is stored). Small, in-character motions.
// RETUNE THIS MAP FOR EVERY NEW VIDEO — beat ids repeat across videos, so a stale map silently
// animates the wrong story.
const MOTION = {
  '11': 'a glowing ball of warm honey light gently lifts a plain blank card and places it onto a simple wooden shelf on the wall, a careful deliberate motion, calm and satisfied',
  ...
  '03': 'three identical plain cards circle slowly around a glowing ball of honey light in a patient repeating loop, going round and round without ending, the man watches with a small tired blink, calm looping motion',
};
