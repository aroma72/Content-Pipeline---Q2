...
// Tuned for VIDEO 03 (where the learning is stored: the ledger, the tools).
// RETUNE FOR EVERY NEW VIDEO — beat ids repeat, so a stale map animates the wrong story.
const MOTION = {
  '10': 'the man writes a fresh line with a pen beneath the existing handwritten lines in the open ledger, the pen travelling steadily across the page, calm satisfied motion',
  '14': 'the man sets a small plain desk calculator down onto the counter with both hands beside the boxy cream monitor, placing it deliberately, calm motion',
  '02': 'the man moves one finger slowly down a column of short handwritten tally marks in the open ledger, counting them off, small precise motion',
};
