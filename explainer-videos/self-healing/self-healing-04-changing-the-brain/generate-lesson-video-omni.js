...
// Tuned for VIDEO 04 (fine-tuning: the five conditions).
// RETUNE FOR EVERY NEW VIDEO — beat ids repeat, so a stale map animates the wrong story.
const MOTION = {
  '14': 'the man stands at the counter and gives a small confident nod toward the box of slips and the monitor, a slow settled breath, gentle motion',
  '03': 'the man pulls a plain wooden box packed tightly with cream paper slips forward onto the polished counter with both hands, the slips shifting slightly as it moves, steady effortful motion',
  '08': 'the man\'s hands move cream paper slips one at a time into four separate shallow trays along the counter, sorting them steadily, calm repeating motion',
};
