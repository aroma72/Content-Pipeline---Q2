...
// Tuned for VIDEO 04 (fine-tuning: the seventh place). Small, in-character motions.
// RETUNE THIS MAP FOR EVERY NEW VIDEO — beat ids repeat across videos, so a stale map silently
// animates the wrong story.
const MOTION = {
  '11': 'the young man stands beside a tall neat stack of plain blank cards on a wooden crate and rests one hand on top of the stack, a small proud nod, gentle motion',
  ...
  '04': 'a glowing ball of honey light slowly deepens into a warmer richer amber and holds that new colour, soft light spreading gently across the room walls, the man watches closely, calm significant motion',
};
