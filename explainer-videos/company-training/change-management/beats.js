 ...
 * House standard: ONE named, invented protagonist (Ali, a team lead) carried
 ...
 * same Ali every beat, warm cream palette, NO baked-in text/letters/numbers.
 */
...
module.exports = [
  ...
  },
  {
    ...
    art: `${ALI}, a thoughtful realization on his face, a soft glowing lightbulb floating near his head, ${HERO}`,
  },
  {
    id: '07',
    mode: 'info',
  ...
  },
  {
    ...
    art: `${ALI} and his team confidently using a new tool together in a bright ed-tech office, momentum and warmth, gentle depth, ${STYLE}`,
  },
];
