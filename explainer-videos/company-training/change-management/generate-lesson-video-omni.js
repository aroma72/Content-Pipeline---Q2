...
const MOTION = {
  '01': 'the small team subtly shifts and gestures while looking at the screen, papers and light flicker gently, soft ambient office motion',
  '02': 'the young man breathes and gives a small confident nod, colleagues behind him move slightly, gentle ambient motion',
  '03': 'the young man gestures warmly toward the floating app tile which pulses softly, he blinks and shifts his weight naturally',
  '04': 'the young man taps the floating envelope icon which bobs gently, he blinks and tilts his head, waiting',
  '05': 'the young man sighs and looks down a little, shoulders drop slightly, he blinks, the calendar hangs still, subtle deflated body language',
  '07': 'the young man walks steadily along the path through the green valley toward the sunrise, natural walk cycle, grass and trees sway gently in the breeze',
  '09': 'the two men have a warm conversation, small head nods and hand gestures, they listen to each other, gentle empathetic motion',
  '10': 'the man guides two colleagues at the desk, they point and nod as they learn together, supportive collaborative motion',
};
