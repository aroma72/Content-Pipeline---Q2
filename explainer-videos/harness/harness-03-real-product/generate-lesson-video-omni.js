...
const MOTION = {
  '12': "the young man gestures gently toward a warm glowing room holding a honey orb with three small openings around it, the orb pulses softly, calm, camera locked",
  '25': "the young man faces the viewer with a confident warm smile and a small nod, gentle breathing, camera locked",
  '05': "the young man calmly arranges a few notes and one small tool around a glowing honey orb on the desk, a purposeful tidying motion, camera locked",
};
