...
const MOTION = {
  '12': "a few simple note cards and pages drift gently toward a glowing honey orb, calm, camera locked",
  '22': "the young man faces the viewer with a confident warm smile and a small sure nod, gentle breathing, camera locked",
  '08': "a glowing honey orb hovers as a few simple tool shapes, a calculator, a folder and a telephone, float gently around it, calm drifting motion, camera locked",
};
