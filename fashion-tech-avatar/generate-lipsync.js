...
const MOTION_PROMPT =
  'A glamorous blonde supermodel young woman sitting at a stylish table, talking straight to the ' +
  'camera in a warm friendly way, natural lip movements synced to her speech, gentle head tilts, ' +
  'soft blinking, subtle expressive smiles and small hand gestures. Keep the exact same polished ' +
  '2D cartoon illustration style, same character, static locked camera. No text.';
...
async function lipsync(imageUrl, audioUrl, key) {
  ...
  const deadline = 15 * 60 * 1000; let waited = 0;
  for (;;) {
