"""
Generate Systems Evaluations Slides with AI-Generated Images
Uses Pollinations.ai (free image generation API)
"""
...
def generate_image_pollinations(prompt, width=600, height=400):
...
def add_image_safe(slide, image_data, left, top, width, height):
    ...
    try:
        ...
        print(f"     Error adding to slide: {e}")
        return False
...
def create_presentation():
    """Create the full presentation with AI-generated images"""
    prs = Presentation()
    ...
    image_prompts = {
        "assessment": "professional assessment evaluation quality control modern minimal",
        "types": "different types methods hybrid approach analytical modern design",
        "framework": "systematic framework process workflow structure planning",
        "rubrics": "scoring rubric assessment criteria detailed evaluation professional",
        "facilitation": "team collaboration facilitation discussion professional training",
        "pitfalls": "mistakes errors prevention quality assurance professional",
        "next_steps": "implementation process steps workflow execution professional"
    }
    ...
    img_data = generate_image_pollinations(image_prompts["types"])
    if img_data:
...
• Best of both worlds"""
    ...
    img_data = generate_image_pollinations(image_prompts["framework"])
    if img_data:
    ...
    print("\n📄 Slide 5: Creating Effective Rubrics")
    ...
    img_data = generate_image_pollinations(image_prompts["rubrics"])
    if img_data:
...
Real sample outputs"""
    ...
    img_data = generate_image_pollinations(image_prompts["facilitation"])
    if img_data:
...
Use feedback to refine rubrics"""
    ...
    img_data = generate_image_pollinations(image_prompts["next_steps"])
    if img_data:
...
print("\n" + "="*70)
print("🎨 GENERATING SYSTEMS EVALUATIONS SLIDES WITH AI IMAGES")
print("   Using Pollinations.ai (free image generation API)")
print("="*70)
...
print("\n" + "="*70)
print(f"✅ COMPLETE! Presentation saved:")
print(f"   {output_path}")
print("\n   Features:")
print("   ✓ 9 professional slides with clean, minimal design")
print("   ✓ AI-generated images (Pollinations.ai)")
print("   ✓ Professional color scheme (navy + teal)")
print("   ✓ Rounded corners and modern formatting")
