...
const MOTION_PROMPT =
  'A photorealistic real young woman with a clean-girl aesthetic and a sleek slicked-back low bun ' +
  'sitting at a stylish table, talking straight to the camera in a warm friendly way, natural lip ' +
  'movements synced to her speech, gentle head tilts, soft blinking, subtle genuine smiles and small ' +
  'hand gestures. Keep the exact same real person, photorealistic, static locked camera. No text.';
